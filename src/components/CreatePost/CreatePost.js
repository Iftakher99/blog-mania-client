      ...
      <div>
        ...
        <div className="mt-5 md:px-20">
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="bg-white">
              <div className="grid grid-cols-1 space-y-2">
                ...
                <input
                  ...
                  className="bg-gray-100 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500"
            ...
            <div>
              <button
                className="mt-5 text-white bg-red-800 hover:bg-red-700 py-2 px-4 rounded"
                type="submit"
              >
                Submit
              </button>
